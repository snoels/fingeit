""" Module contains fixups for known translation issues.

For every dataset that is translated, there are some issues that need to be fixed.
Every dict in this module contains the fixup for the known issues.
